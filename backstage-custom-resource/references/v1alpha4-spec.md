# Backstage CR API v1alpha4 Specification

API Version: `rhdh.redhat.com/v1alpha4`

Source: https://github.com/redhat-developer/rhdh-operator/blob/main/api/v1alpha4/backstage_types.go

## Changes from v1alpha3

- **Added**: `spec.monitoring` field for Prometheus metrics
...
type BackstageSpec struct {
    ...
    Monitoring       Monitoring           `json:"monitoring,omitempty"`  // NEW
...
func (s *BackstageSpec) IsMonitoringEnabled() bool  // NEW
```
...
| `spec.monitoring.enabled` | bool | **NEW**: Enable Prometheus metrics |
